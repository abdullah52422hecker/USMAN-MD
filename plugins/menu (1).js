...
try{
let desc = `🌟 *𝑮𝑶𝑶𝑫 ${new Date().getHours() < 12 ? '𝑴𝑶𝑹𝑵𝑰𝑵𝑮' : '𝑵𝑰𝑮𝑯𝑻'}, ${pushname}!* 🌟
...
const vv = await conn.sendMessage(from, { 
  ...
  contextInfo: { 
    ...
    forwardedNewsletterMessageInfo: { 
      ...
      newsletterName: "DARK-SILENCE-MD-MENU", 
      serverMessageId: 999 
    }, 
    externalAdReply: { 
...
await conn.sendMessage(from, { image: { url:`https://files.catbox.moe/8fy6up.jpg`}, caption: owner, 
        ...
        forwardedNewsletterMessageInfo: {
          newsletterJid: '120363189714152560@newsletter',
          newsletterName: '𝑫𝑨𝑹𝑲-𝑺𝑰𝑳𝑬𝑵𝑪𝑬-𝑴𝑫',
          serverMessageId: 143
        }
      }
    }, {
