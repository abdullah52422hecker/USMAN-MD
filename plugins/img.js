    ...
    try {
        ...
        for (const imageUrl of selectedImages) {
            await conn.sendMessage(
                ...
                { 
                    image: { url: imageUrl },
                    caption: `*📷 USMAN-MD IMG FIND:* ${query}\n> © POWERD BY USMAN SER ♥️🌸`
                },
                { quoted: mek }
            );
...
cmd({
  ...
  try {
    ...
    await reply("> *USMAN-MD CREATING IMAGINE ...🔥*");
    ...
    await conn.sendMessage(m.chat, {
      image: imageBuffer,
      caption: `💸 *IMAGINE GENERATED BY USMAN-MD* 🚀\n✨ PROMPT: *${q}*`
    });
...
cmd({
  ...
  try {
    ...
    if (_0x235f6c.data.status) {
      ...
      const _0x122bb7 = "USMAN-MD 🌌 RANDOM WALLPAPER: *" + _0x2d400f + "*\n\n> *© ¢яєαтє∂ ву υѕмαη ѕєя*";
...
cmd({
  ...
  try {
    _0x30d3fc("*💑 USMAN-MD FETCHING COUPLE PROFILE PICTURES...*");
        ...
        'message': {
          ...
          'interactiveMessage': proto.Message.InteractiveMessage.fromObject({
            'body': proto.Message.InteractiveMessage.Body.create({
              'text': "*_USMAN-MD PIN 📍 DOWNLOADEDER..🚀_*"
            }),
