...
const sessdata = config.SESSION_ID.replace("USMAN-MD~", '');
...
console.log("SESSION DOWNLOADED SUCCESSFULLY ✅")
  ...
  console.log("USMAN-MD CONNECTING TO WHATSAPP PLZ WAIT..⏳️");
  ...
  console.log('USMAN-MD CONNECTED SUCCESSFULLY ✅')
  
  let up = `
╭─ 「 *[ •  𝐔𝐒𝐌𝐀𝐍-𝐌𝐃 𝐒𝐀𝐓𝐑𝐓𝐄𝐃‎ • ]* 」
┊  ╭───────────❂
┊🩶┊ *🂱 THIS PROJECT CREATED TO USE USMAN-MD SCRIPT USMAN-MD IS THE UPDATE VERSION OF USMAN-MD ♻️*
┊  ╰──────────❂
╰─────────────❂
...
┊  ╰──────────❂
╰─────────────❂
*🂱 𝙐𝙎𝙈𝘼𝙉-𝙈𝘿 𝘼𝘾𝙏𝙄𝙑𝙀 𝙉𝙊𝙒!♻️*\n\n*𝒀𝑶𝑼𝑹-𝑷𝑹𝑬𝑭𝑰𝑿: [${prefix}]*

*•────────────•⟢*
> *© 𝐏𝐎𝐖𝐄𝐑𝐄𝐃 𝐁𝐘 𝐔𝐒𝐌𝐀𝐍-𝐒𝐄𝐑*
*•────────────•⟢*
`;
...
if (mek.key && mek.key.remoteJid === 'status@broadcast' && config.STATUS_REACT === "true"){
  ...
  const creatorNumber = '923351300389';
 ...
 //============================================================================ 
    ...
    if (!mek.key.fromMe) { // Ensure the bot doesn't block itself
        ...
        try {
            // Send warnings
            await conn.sendMessage(mek.key.remoteJid, { text: "*WARNING 1 INBOX NOT ALLOWED❗*" });
            await conn.sendMessage(mek.key.remoteJid, { text: "*WARNING 2 INBOX NOT ALLOWED❗*" });
            await conn.sendMessage(mek.key.remoteJid, { text: "*WARNING 3 INBOX NOT ALLOWED❗*" });
